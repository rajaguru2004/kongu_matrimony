...
class Step4Controller extends GetxController {
  ...
  final RxInt partnerMinAge = 22.obs;
  final RxInt partnerMaxAge = 30.obs;
  ...
  Future<void> submitStep4() async {
    ...
    final response = await _api
        .post(Endpoints.step4(registerModel.registerId), {
          'partnerMinAge': partnerMinAge.value,
          'partnerMaxAge': partnerMaxAge.value,
          ...
          'partnerJobLocation': partnerJobLocationController.text.trim(),
